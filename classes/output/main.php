...
class main implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $url = (empty($config->categorytile1image)) ? false : \moodle_url::make_pluginfile_url($context->id,'block_categorytiles','categorytile1image',null,"/",$config->categorytile1image);
        $categorytile1imageurl = new \moodle_url($url);
        $categorytile1imageurl = $categorytile1imageurl->out();
